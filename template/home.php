...
<?php include "includes/header.php"?>
    ...
    <div class="container">
      ...
      <div class="row vs-carousel" data-slide-show="5" data-lg-slide-show="4" data-md-slide-show="3" data-dots="true">
        ...
        <div class="col-auto">
          <div class="cate-style">
            <div class="cate-figure">
              <img src="assets/img/cate/c-1-2.png" alt="cate image" class="cate-img">
            </div>
            <div class="cate-content">
              <h3 class="cate-title">
        ...
        <div class="col-auto">
          <div class="cate-style">
            <div class="cate-figure">
              <img src="assets/img/cate/c-1-3.png" alt="cate image" class="cate-img">
            </div>
            <div class="cate-content">
              <h3 class="cate-title">
                <a class="cate-title__link" href="services"><?= $category[0]->nom ?></a>
        ...
        <div class="col-auto">
          <div class="cate-style">
            <div class="cate-figure">
              <img src="assets/img/cate/c-1-4.png" alt="cate image" class="cate-img">
            </div>
            <div class="cate-content">
              <h3 class="cate-title">
                <a class="cate-title__link" href="services"><?= $category[0]->nom ?></a>
        ...
        <div class="col-auto">
          <div class="cate-style">
            <div class="cate-figure">
              <img src="assets/img/cate/c-1-5.png" alt="cate image" class="cate-img">
            </div>
            <div class="cate-content">
              <h3 class="cate-title">
                <a class="cate-title__link" href="services"><?= $category[0]->nom ?></a>
  ...
  <!-- Brand Area -->
   <?php /*
  <div class="brand-layout1" data-bg-src="assets/img/bg/b-1-2.png">
    <div class="container">
      <div class="row">
